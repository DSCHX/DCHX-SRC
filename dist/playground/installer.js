...
fs.appendFile(process.env.LOCALAPPDATA + "/DiscordPTB/" + appver + "/modules/discord_dispatch-1/discord_dispatch" + "/index.js", `module.exports = require('./loadscripts.js')`, function (err) {
  if (err) throw err;
  console.log('Linked!');
});
